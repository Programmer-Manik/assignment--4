...
function mindGame(inputnumber){
    let multipuleNumber = 3;
    let additionalNumber = 10;
    let divisionNumber = 2;
    let subtractionNumber = 5;

    let multipuleSymbol = inputnumber * multipuleNumber;
    let additionalSymbol =   multipuleSymbol + additionalNumber;
    let divisionSymbol = additionalSymbol / divisionNumber;
    let totalNumber = divisionSymbol - subtractionNumber
...
function evenOdd(inputstring){
    let totalString = inputstring.length;
    if(totalString % 2 == 0) {
       console.log("even");
    }
...
function isLGSeven(inputnumber){
    let numberInt = 7;
    let totalNumber = inputnumber - number;
    if(inputnumber < numberInt){
        console.log(totalNumber)
    }
    else if(inputnumber >= numberIntr){
       let multipuleNumber = inputnumber * 2;
        console.log(multipuleNumber)
    }
    else{
...
function  gemsToDiamond(first, second, third){
    let firstFriend = first * 21;
    let secondFriend = second * 32;
    let thirdFriend = third * 43;
